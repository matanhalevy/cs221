...
#define REPETITIONS 100      //!< REPETITIONS = the number of times to repeat each "scheme". 
...
int SEQUENTIAL_CUTOFF = 2;   //!< A full binary tree has (2^(n+1) - 1) nodes, so with n = 9, at most (2^10 - 1) = 1023 nodes 
